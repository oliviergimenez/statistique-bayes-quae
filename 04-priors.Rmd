...
knitr::include_graphics('images/informativeprior.png')
```
...
```{r prior-combined-ggplot, fig.cap="Comparaison de deux priors obtenus sur la probabilité \\( \\theta = \\text{logit}^{-1}(\\beta) \\) après transformation par la fonction logit réciproque de \\( \\beta \\sim N(0, 10^2) \\) et \\( \\beta \\sim N(0, 1.5^2) \\).", out.width='100%', fig.align='center', message=FALSE, warning=FALSE, echo = FALSE, dpi = 600}
library(ggplot2)
library(dplyr)
