...
```{r posterior-comparaison, echo = FALSE, fig.cap = "Comparaison entre la postérieure exacte (couleur rouge brique) et l’approximation numérique (couleur crème).", dpi = 600}
a <- 1; b <- 1
y <- 19; n <- 57
