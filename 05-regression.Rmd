...
```{r fig-posterior-regression, echo = TRUE, fig.cap = "Histogramme des distributions a posteriori (colonne de gauche) et trace (colonne de droite) des paramètres de la régression linéaire.", dpi = 600}
plot(lm.brms)
```
...
```{r brms-fit-plot, echo=TRUE, fig.cap="Ajustement du modèle linéaire par brms. La droite rouge correspond à la vraie relation utilisée pour simuler les données. La droite bleue est la régression estimée, obtenue en fixant l'ordonnée à l'origine et la pente à leur moyenne a posteriori, entourée de son intervalle de crédibilité à 95 %.", dpi = 600}
